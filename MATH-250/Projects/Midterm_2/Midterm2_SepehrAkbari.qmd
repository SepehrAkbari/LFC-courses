...
Although we performed a two-sided test, the observed mean difference (2.68 blocks, with a 95% confidence interval of approximately 2.11 to 3.25) is in the hypothesized direction (more cubes than cylinders). This allows us to make a one-sided conclusion: on average, children stack significantly more cubes than cylinders. This finding provides strong evidence that **the shape of the blocks influences stacking ability, with cubes allowing for higher stacking than cylinders.**
