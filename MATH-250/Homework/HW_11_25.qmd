...
- Null Hypothesis (H_0): The average `bill_length_mm` is not linearly related to `bill_depth_mm`. Specifically, the slope of the regression line is zero (\beta_1 = 0).

- Alternative Hypothesis (H_1): The average `bill_length_mm` is linearly related to `bill_depth_mm`. Specifically, the slope of the regression line is not zero (\beta_1 \neq 0).
